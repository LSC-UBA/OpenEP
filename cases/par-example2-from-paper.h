...
const long double x_max = 4e-2;
/* Maximum length of the y axis [m] */
const long double y_max = 5e-2;
/* Maximum length of the z axis [m] */
const long double z_max = 2e-2;

/* ----------------------- Treatment parameters ---------------------------- */

/* Voltage to distance ratio [V m^-1] */
const long double volt_to_dist = 150000.;
/* Frequency [Hz] */
const long double freq = 1.;
/* On time [s] */
const long double on_pulse_time = 1e-4;
/* No. of pulses */
const long double nbr_pulses = 32;
