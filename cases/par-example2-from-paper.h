...
/* Electrode length [m] */
const long double electrode_length = 1e-2;
/* Electrode width [m] */
const long double electrode_width = 1e-3;
/* Electrode thickness [m] */
const long double electrode_thickness = 1e-3;
/* Space between anode-cathode, horizontally [m] */
const long double gap_anode_cathode = 1e-2;
...
const int no_electrodes = 3;

/* ------------------------- Domain parameters ----------------------------- */

/* Maximum length of the x axis [m] */
const long double x_max = 8e-2;
/* Maximum length of the y axis [m] */
const long double y_max = 10e-2;
/* Maximum length of the z axis [m] */
const long double z_max = 1.5e-2;

/* ----------------------- Treatment parameters ---------------------------- */

/* Voltages to distance ratio [V m^-1] */
const double volt_to_dist[] = {150000};
/* On times [s] */
const double on_pulse_times[] = {1e-4};
/* Off times [s] */
const double off_pulse_times[] = {0.9999};
/* How many repetitions of each pulse */
const int pulse_repetitions[] = {32};
...
const long double sigma_domain_init = 0.03;
/* Tissue density [ kg m^3 ] */
const long double rho = 1100.;
/* Heat capacity [J kg^-1 K^-1] */
const long double cp = 3780.;
/* Metabolic heat generation [ W m^-3 ] */
const long double qm = 2161.;                                            
...
const long double dt_fractions_off = 4999500;
inline const long double * dts_off_pulse = dts_on_pulse;
